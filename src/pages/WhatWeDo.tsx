...
const WhatWeDo = () => {
  return (
    <div className="container mx-auto py-12 px-4 md:px-6">
      <h1 className="text-4xl font-bold text-center mb-10 text-primary" id="what-we-do-page">What We Do</h1>

      <section className="mb-12 bg-secondary p-8 rounded-lg shadow-lg border border-border">
        <h2 className="text-3xl font-semibold mb-6 text-primary text-center" id="core-initiative">Core Initiative: Weekly Food Distribution – Nourishing Bodies, Inspiring Hope</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <Card className="bg-card shadow-lg transition-transform duration-300 hover:scale-105 border border-border h-full flex flex-col">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-primary flex items-center gap-2" id="program-details">
                <Utensils className="h-6 w-6 text-accent" /> Our Program Details
              </CardTitle>
            </CardHeader>
            <CardContent className="text-gray-700 space-y-3 flex-grow flex flex-col justify-between p-4">
              ...
              <ul className="list-disc list-inside space-y-1 pl-4">
                ...
                <li><strong>Impact:</strong> Each meal we distribute provides essential physical nourishment, offers a much-needed moment of comfort, and delivers a powerful message of hope. This support helps individuals gain the strength and resilience required to face another day with renewed spirit and dignity.</li>
              </ul>
              <Button asChild variant="link" className="mt-auto text-accent hover:text-accent/90">
                <Link to="/donate-food">Support a Meal</Link>
              </Button>
            </CardContent>
          </Card>
      ...
      <section className="bg-background p-8 rounded-lg shadow-lg border border-border">
        <h2 className="text-3xl font-semibold mb-6 text-primary text-center" id="special-initiatives">Special Initiatives: Spreading Joy Beyond Meals</h2>
        <p className="text-lg text-gray-700 leading-relaxed mb-8 text-center max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="bg-card shadow-lg transition-transform duration-300 hover:scale-105 border border-border h-full flex flex-col">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-primary flex items-center gap-2" id="celebrate-your-special-day">
          ...
          <Card className="bg-card shadow-lg transition-transform duration-300 hover:scale-105 border border-border h-full flex flex-col">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-primary flex items-center gap-2" id="gau-seva">
          ...
          <Card className="bg-card shadow-lg transition-transform duration-300 hover:scale-105 border border-border h-full flex flex-col">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-primary flex items-center gap-2" id="custom-donation-requests">
