...
const PrivacyPolicy = () => {
  return (
    <div className="container mx-auto py-12 px-4 md:px-6 prose max-w-4xl">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-secondary-foreground">How We Use Your Information:</h2>
      <p className="text-lg text-gray-700 mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4 text-secondary-foreground">Data Security:</h2>
      <p className="text-lg text-gray-700 mb-4">
