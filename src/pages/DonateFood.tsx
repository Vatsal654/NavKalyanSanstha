    ...
    <div className="container mx-auto py-12 px-4 md:px-6">
      ...
      <section className="mb-12 max-w-3xl mx-auto bg-secondary p-8 rounded-lg shadow-lg border border-border">
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-8">
          Nav Kalyan Sanstha Delhi is on a mission to deliver this hope directly to those in need. Your contribution, no matter the size, directly translates into a freshly cooked, wholesome meal served with dignity and love. Join us in this sacred act of 'Anna Daan' and help us nourish bodies and spirits across Delhi. Every single rupee you donate goes directly towards preparing and distributing these vital meals, ensuring maximum impact.
        </p>
      ...
      <Card className="max-w-3xl mx-auto shadow-lg border border-border bg-card">
        ...
        <CardContent className="space-y-6">
          <p className="text-lg text-gray-700 leading-relaxed text-center">
            After making the payment, we kindly request you to share a screenshot of your payment confirmation via WhatsApp to <a href="https://wa.me/919118898507" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline"><strong>+919118898507</strong></a>. This helps us track your valuable contribution, issue a confirmation, and if applicable, your 80G tax-exemption certificate.
          </p>
          ...
          <div className="p-6 bg-primary/10 border-l-4 border-primary rounded-md text-gray-800 mt-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700">
              ...
              <li>After donating, please share a screenshot of your payment with us via WhatsApp at <a href="https://wa.me/919118898507" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline"><strong>+919118898507</strong></a>. This helps us track your generous contribution, send a confirmation, and process your 80G certificate efficiently.</li>
      ...
      <div className="mt-8 text-center text-gray-700 bg-muted p-6 rounded-lg shadow-sm border border-border">
        ...
        <p>Please call us at <a href="tel:+919118898507" className="text-blue-500 hover:underline"><strong>+919118898507</strong></a> or email us at <a href="mailto:donations@navkalyansansthadelhi.org" className="text-blue-500 hover:underline"><strong>donations@navkalyansansthadelhi.org</strong></a>.</p>
