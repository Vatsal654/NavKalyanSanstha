  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-4rem)]">
      ...
      <section className="relative min-h-[70vh] flex flex-col items-center justify-center text-center text-white overflow-hidden py-16 md:py-24">
        <div
          className="absolute inset-0 bg-cover bg-center bg-no-repeat bg-gray-200 dark:bg-gray-700" // Fallback bg
      ...
      {/* About Us Snippet */}
      <section className="py-16 bg-secondary text-foreground"> {/* Changed to secondary blue */}
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto mb-8">
            Nav Kalyan Sanstha Delhi began with a simple yet profound realization: food is not a privilege, it is a fundamental human right. We are a non-profit, women-led organization dedicated to serving fresh, home-cooked meals to those in need, bridging the gap between compassion and action. Our journey started with a small group of dedicated women, and has grown into a community-driven movement.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="text-left">
              <h3 className="text-2xl font-semibold mb-4 text-primary dark:text-primary-foreground">Our Vision & Mission</h3>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Our vision is to create a hunger-free Delhi where every individual has access to nutritious food and is treated with dignity. Our mission is to consistently prepare and distribute healthy, hygienic, and tasty home-cooked meals to underprivileged children and individuals. We are committed to maintaining a transparent, heartfelt, and accessible platform for donors to contribute and witness the direct impact of their generosity.
              </p>
            ...
            <div className="relative overflow-hidden rounded-lg shadow-xl min-h-[200px] bg-gray-200 dark:bg-gray-700"> {/* Added fallback bg and min-h */}
              <img
      ...
      {/* What We Do Snippet - Addressing Screenshot 3 */}
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-primary-foreground/90 max-w-3xl mx-auto mb-10">
            Beyond our regular food distribution, we organize special programs that allow our community to engage in unique acts of kindness and celebrate life's moments with those less fortunate. Each initiative is a step towards a more compassionate society, fostering hope and well-being.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-card text-card-foreground shadow-lg transition-transform duration-300 hover:scale-105 border border-border">
              ...
              <CardContent className="text-gray-700 dark:text-gray-300">
                <p className="mb-4">Our core program: every Tuesday and Saturday, we distribute hundreds of healthy, home-cooked meals to underprivileged children and individuals across various locations in Delhi, ensuring no one goes hungry.</p>
                <ul className="list-disc list-inside text-left pl-4 space-y-1 text-sm">
                  <li>**Impact:** Providing consistent nourishment and hope.</li>
                  <li>**Frequency:** Every Tuesday & Saturday.</li>
                  <li>**Cost:** Just ₹21 per meal.</li>
                </ul>
            ...
            <Card className="bg-card text-card-foreground shadow-lg transition-transform duration-300 hover:scale-105 border border-border">
              ...
              <CardContent className="text-gray-700 dark:text-gray-300">
                <p className="mb-4">Make your special occasions—birthdays, anniversaries, or milestones—truly unforgettable. Celebrate by sharing a cake and meals with the children we serve, creating unforgettable moments of joy.</p>
                <ul className="list-disc list-inside text-left pl-4 space-y-1 text-sm">
                  <li>**Occasions:** Birthdays, Anniversaries, Milestones.</li>
                  <li>**Activity:** Cake cutting & meal sharing.</li>
                  <li>**Contribution:** ₹500-₹600.</li>
                </ul>
                <Button asChild variant="link" className="mt-4 text-accent hover:text-accent/90">
            ...
            <Card className="bg-card text-card-foreground shadow-lg transition-transform duration-300 hover:scale-105 border border-border">
              ...
              <CardContent className="text-gray-700 dark:text-gray-300">
                <p className="mb-4">Extend your kindness to all living beings through our Gau Seva (cow feeding) program. We facilitate donations for providing fodder and essential care for these gentle animals.</p>
                <ul className="list-disc list-inside text-left pl-4 space-y-1 text-sm">
                  <li>**Gau Seva:** Support cow feeding and care.</li>
                  <li>**Custom Donations:** Tailor your contribution to specific needs.</li>
                  <li>**Flexibility:** Contact us for unique acts of charity.</li>
                </ul>
                <Button asChild variant="link" className="mt-4 text-accent hover:text-accent/90">
      ...
      <section className="py-16 bg-secondary text-foreground"> {/* Changed to secondary blue */}
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto mb-10">
            Your support is the backbone of our mission. Here are a few ways you can make a profound difference in the lives of those we serve, contributing to a brighter future for our community.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-card shadow-lg transition-transform duration-300 hover:scale-105 border border-border">
              ...
              <CardContent className="text-gray-700 dark:text-gray-300">
                <p className="mb-4">Provide a nutritious, home-cooked meal for just ₹21. Every donation directly feeds someone in need and brings a smile to their face, offering essential sustenance and hope.</p>
            ...
            <Card className="bg-card shadow-lg transition-transform duration-300 hover:scale-105 border border-border">
              ...
              <CardContent className="text-gray-700 dark:text-gray-300">
                <p className="mb-4">Join our dedicated team of volunteers. Your time and effort are invaluable in preparing and distributing meals, and connecting with the community to make a tangible difference on the ground.</p>
                <Button asChild variant="link" className="mt-4 text-accent hover:text-accent/90">
            ...
            <Card className="bg-card shadow-lg transition-transform duration-300 hover:scale-105 border border-border">
              ...
              <CardContent className="text-gray-700 dark:text-gray-300">
                <p className="mb-4">Mark your special occasions by sharing joy with underprivileged children. A unique way to celebrate and make your milestones truly meaningful by giving back to the community!</p>
                <Button asChild variant="link" className="mt-4 text-accent hover:text-accent/90">
      ...
      <section className="py-16 bg-muted dark:bg-gray-900">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto mb-10">
            Witness the smiles your generosity creates. Our gallery captures the heartwarming moments from our distribution drives, showcasing the real impact of your support and the joy it brings to countless lives.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="relative overflow-hidden rounded-lg shadow-lg cursor-pointer group min-h-[150px] bg-gray-200 dark:bg-gray-700"> {/* Added fallback bg and min-h */}
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-primary-foreground/90 max-w-3xl mx-auto mb-8">
            Have questions, want to volunteer, or collaborate? We'd love to hear from you. Your engagement helps us grow and serve more effectively, strengthening our community bonds.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-center">
            <div className="relative overflow-hidden rounded-lg shadow-xl col-span-full lg:col-span-2 min-h-[200px] bg-gray-200 dark:bg-gray-700"> {/* Added fallback bg and min-h */}
              <img
            ...
            <Card className="bg-card shadow-lg transition-transform duration-300 hover:scale-105 border border-border">
              ...
              <CardContent className="text-gray-700 dark:text-gray-300">
                <p className="mb-4">Find answers to common questions about our mission, donations, and operations quickly and easily. Our comprehensive FAQ section is designed to provide clarity.</p>
                <Button asChild variant="link" className="mt-4 text-accent hover:text-accent/90">
            ...
            <Card className="bg-card shadow-lg transition-transform duration-300 hover:scale-105 border border-border">
              ...
              <CardContent className="text-gray-700 dark:text-gray-300">
                <p className="mb-4">Reach out to us via phone, email, or visit our office. We're here to help with any inquiries, collaborations, or volunteer opportunities you may have!</p>
                <Button asChild variant="link" className="mt-4 text-accent hover:text-accent/90">
